...
function submit(){
    ...
    var length_of_name_student_array = name_student_array.length;
...
function sorting(){
    ...
    var length_of_name_student_array = name_of_student_array.length;
    console.log(length_of_name_student_array);

    for (var k = 0; k < length_of_name_student_array; k++) {
        display_student_array.push("<h4>NAME - " + name_of_student_array);
        console.log(display_student_array);
